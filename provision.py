...
def provision_remoteio():
  ...
  # Provision GPIO mode configuration
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_BLUE, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_WHITE, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_RED, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_GREEN, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_YELLOW, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + BUTTON, 0)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_XRAY, 1)
  safeops.write(remote_io, REMOTEIO_GPIO_MODE_BASE + INDICATOR_SIREN, 1)
